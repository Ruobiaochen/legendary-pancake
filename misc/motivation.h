...
(A)
module: vector space over a ring, or analogy to group action
...
chain complex (of modules): analogy to chain of boundary operators of a manifold
exact sequence: the space represented by it(as a chain complex) has trivial homology groups.
split: the chain can be somewhat breaked
